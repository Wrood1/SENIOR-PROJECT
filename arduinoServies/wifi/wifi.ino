...
// room 2
  if (Firebase.RTDB.setString(&fbdo, "/location1/room2/fire2", fire1)) {
  ...
  if (Firebase.RTDB.setString(&fbdo, "/location1/room1/gas1", gas1)) {
  ...
  if (Firebase.RTDB.setString(&fbdo, "/location1/room2/gas1", gas2)) {
  ...
  if (Firebase.RTDB.setString(&fbdo, "/location1/room1/temp1", temp1)) {
  ...
  if (Firebase.RTDB.setString(&fbdo, "/location1/room1/humidity1", hum1)) {
  ...
  if (Firebase.RTDB.setString(&fbdo, "/location1/room2/temp1", temp2)) {
  ...
  if (Firebase.RTDB.setString(&fbdo, "/location1/room2/humidity1", hum2)) {
