...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Widget _buildFormContainer() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.grey.withOpacity(0.2), // Light beige container
      ...
      child: Column(
        ...
        children: [
          _buildTextFormField(
            ...
            label: 'Name',
            hintText: 'Your Name, e.g : Arjwan Saud',
            validator: (value) {
          ...
          _buildTextFormField(
            ...
            label: 'Email',
            hintText: 'Your email, e.g : Arjwan.aud@gmail.com',
            validator: (value) {
              if (value == null || value.isEmpty) {
...
Widget _buildPositionDropdown() {
  ...
  return Container(
    ...
    height: 55,
    decoration: BoxDecoration(
      color: AppColors().primaryColor, // Changed to brown
      borderRadius: BorderRadius.circular(30),
    ),
    child: TextButton(
